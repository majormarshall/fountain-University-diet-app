...
-- ============================================================
-- SEED: sickle_foods (4 Nigerian foods for sickle cell diet)
-- ============================================================
...
VALUES
  (
    ...
    'Ugu (Pumpkin Leaves)',
    'Vegetable',
    'High in iron, folate and antioxidants—excellent for blood support.',
    true, false,
    '{"calories": 40, "protein": 3.2, "iron": "High", "folate": "High", "hydrationScore": 4, "antiInflammatoryScore": 4}',
    '["beta-carotene", "polyphenols", "iron-dense", "vitamin C"]'
  ),
  (
    'zobo',
    ...
    true, false,
    '{"calories": 15, "protein": 0, "iron": "Low", "folate": "Low", "hydrationScore": 5, "antiInflammatoryScore": 4}',
  ...
  (
    ...
    'Moi Moi',
    'Legume',
    'Steamed bean pudding — gentle on digestion and iron-supportive.',
    true, false,
    '{"calories": 250, "protein": 12, "iron": "Medium", "folate": "Medium", "hydrationScore": 3, "antiInflammatoryScore": 3}',
  ...
  (
    ...
    'Plantain (Dodo - Fried)',
    'Snack',
    'High oil content — limit for inflammation reasons.',
    false, true,
    '{"calories": 350, "protein": 2, "iron": "Low", "folate": "Low", "hydrationScore": 1, "antiInflammatoryScore": 1}',
    '[]'
  )
